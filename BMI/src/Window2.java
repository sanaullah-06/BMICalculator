...
public class Window2 {
	...
	private void initialize() {
		...
		btnUsUnits.setBackground(new Color(0, 0, 139));
		...
		btnMetricUnits.setBackground(Color.LIGHT_GRAY);
		...
		txtrCm.setBounds(142, 341, 260, 32);
		...
		btnCalculate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				sum = Math.floor((w/(hf*hf))*100)/100;
		...
		lblBmi.setBounds(502, 161, 210, 35);
		frame.getContentPane().add(lblBmi);
		
		JLabel label = new JLabel("()");
		label.setFont(new Font("Arial", Font.BOLD, 20));
		label.setBounds(740, 161, 189, 35);
